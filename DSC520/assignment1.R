...
z<-c(6.1,8.8,7.7,6.4,6.2,6.9,6.6)
week1_sleep <-z
...
factor_recommendations_vector <- factor(recommendations_vector,ordered = TRUE,levels=c("yes","neutral","no"))
